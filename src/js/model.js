...
const sIntrumentDisplayNames = [String.fromCodePoint(876) + ' House', '💸🏡 Mortgage', '💳 Debt', '💸💰 Monthly Expenses', '💲💰 Income', '🧾📈 Taxable Account', '⏳📈 Tax Deferred Account', '📈 Tax Free Account', '🏛️ US Treasury', '🏛️ Corporate Bond', '🏦 Savings', '💰 Cash'];
